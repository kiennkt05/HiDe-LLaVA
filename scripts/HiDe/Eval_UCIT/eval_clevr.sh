...
CUDA_VISIBLE_DEVICES=$GPU python -m llava.eval.model_answer \
    ...
    --question-file /home/s24gbn1/Documents/kienNguyen/HiDe-LLaVA/UCIT/instructions/CLEVR/test_3000.json \
...
python -m llava.eval.eval_deepseek_r1 \
    --annotation-file /home/s24gbn1/Documents/kienNguyen/HiDe-LLaVA/UCIT/instructions/CLEVR/test_3000.json \
