...
deepspeed --master_port 29601 llava/train/train_mem_MOE.py \
    ...
    --previous_task_model_path ~/Documents/kienNguyen/HiDe-LLaVA/HiDe/a_Task2_llava_lora_ours \
    ...
    --bf16 True \
    --output_dir /home/s24gbn1/Documents/kienNguyen/HiDe-LLaVA/HiDe/a_Task3_llava_lora_ours \
    --num_train_epochs 1 \
